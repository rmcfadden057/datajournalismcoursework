...
```{r}
#I think the reason the buyer annual and buyer addresses records are higher than the buyer total is because there are certain pharamacies that has missing information. 
...
buyer_addresses %>%
select(buyer_addresses, buyer_annual_by_year, buyer_totals) %>% 
arrange(desc(buyer_totals)) %>%
